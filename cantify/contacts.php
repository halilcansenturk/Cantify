        ...
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">HAKKINDA</p>
                    <h2 class="fw-bold">NEREYE KOYDUYSAN ORDADIR NEDİR?</h2>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div>
                        <h3 class="fw-bold mb-0"> Arkadaşlarım ile saçmaladığımız, eğlendiğimiz, bilimsel konular konuştuğumuz (!) ve anılarımızı biriktirdiğimiz bir podcasttir.</h3>
                    </div>
                </div>
                    ...
                    <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">05546908134</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">halil.senturk@ogr.dpu.edu.tr</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">Kütahya</p>
                            </div>
                        </div>
                    </div>
                </div>
